            ...
            {Object.keys(products).map(function (product) {
              return (
                <li key={product}>
                  ...
                  <p className="type">Total Cost: {products[product].price} x {products[product].quantity}

                  </p>
                    <p className="val">Discount: {products[product].discount}%

                    </p> <p className="val2">Import Fee: {products[product].importfee}%
